//
//  WorkoutSessionScreenOverviewDetail.swift
//  MindAndBody
//
...
//
class WorkoutSessionScreenOverviewDetail: UIViewController, UIScrollViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UINavigationControllerDelegate {
    ...
    func navigationController(_ navigationController: UINavigationController, willShow viewController: UIViewController, animated: Bool) {
        if let controller = viewController as? WorkoutSessionScreenOverview {
