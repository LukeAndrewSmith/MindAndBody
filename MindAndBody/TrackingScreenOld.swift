...
//
class TrackingScreenOld: UIViewController, UITableViewDelegate, UITableViewDataSource {
//UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func drawGraph() {
        ...
        let yModel = ChartAxisModel(lineColor: Colors.light, firstModelValue: 0, lastModelValue: 125, axisValuesGenerator: generator, labelsGenerator: labelsGenerator2)
        ...
        //
        // Target
        let guideLinesHighlightLayerSettings = ChartGuideLinesLayerSettings(linesColor: Colors.green, linesWidth: 0.5)
        ...
        //
        // Line
        let lineModel = ChartLineModel(chartPoints: chartPoints, lineColor: Colors.red, animDuration: 1.0, animDelay: 0)
        ...
        let circleViewGenerator = {(chartPointModel: ChartPointLayerModel, layer: ChartPointsLayer, chart: Chart) -> UIView? in
            ...
            circleView.fillColor = Colors.red
            return circleView
        }
...
//        let trackerLayerSettings = ChartPointsLineTrackerLayerSettings(thumbSettings: thumbSettings)
        ...
        let chartPointsTrackerLayer = ChartPointsLineTrackerLayer<ChartPoint, Any>(xAxis: xAxisLayer.axis, yAxis: yAxisLayer.axis, lines: [chartPoints], lineColor: Colors.dark, animDuration: 1, animDelay: 2, settings: trackerLayerSettings) { chartPointsWithScreenLoc in
            ...
            for (index, chartPointWithScreenLoc) in chartPointsWithScreenLoc.enumerated() {
                ...
                label.backgroundColor = Colors.dark
        ...
        if selectedTimeScale > 1 {
            ...
            //
            let dividersSettings =  ChartDividersLayerSettings(linesColor: Colors.light, linesWidth: 0.5, start: length, end: 0)
    ...
    func returnXAxisModel(xAxisValues: [ChartAxisValue], titleLabelSettings: ChartLabelSettings, axisLabelSettings: ChartLabelSettings, xAxisTitle: String, generator: ChartAxisGeneratorMultiplier) -> ChartAxisModel {
        ...
        case 1:
            ...
            let xModel = ChartAxisModel(lineColor: Colors.light, firstModelValue: (firstDate.timeIntervalSince1970), lastModelValue: (lastDate?.timeIntervalSince1970)!, axisTitleLabels: [ChartAxisLabel(text: xAxisTitle, settings: titleLabelSettings)], axisValuesGenerator: xValuesRangedGenerator, labelsGenerator: xLabelGenerator)
        ...
        case 2:
            ...
            let xModel = ChartAxisModel(lineColor: Colors.light, firstModelValue: startDate.timeIntervalSince1970, lastModelValue: (endDate?.timeIntervalSince1970)!, axisTitleLabels: [], axisValuesGenerator: xValuesRangedGenerator, labelsGenerator: xLabelGenerator)
        ...
        case 4:
            ...
            //
            let xModel = ChartAxisModel(lineColor: Colors.light, firstModelValue: startDate.timeIntervalSince1970, lastModelValue: (endDate?.timeIntervalSince1970)!, axisTitleLabels: [ChartAxisLabel(text: xAxisTitle, settings: titleLabelSettings)], axisValuesGenerator: xValuesRangedGenerator, labelsGenerator: xLabelGenerator, trailingPadding: ChartAxisPadding.label)
        ...
        //
        default:
            let xModel = ChartAxisModel(axisValues: xAxisValues, lineColor: Colors.light, axisTitleLabels: [ChartAxisLabel(text: xAxisTitle, settings: titleLabelSettings)], leadingPadding: ChartAxisPadding.label, trailingPadding: ChartAxisPadding.label)
            return xModel
        }
    }
