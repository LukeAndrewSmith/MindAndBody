...
//        let yogaAverage = Double((difficultyLevels[0][0] + balanceAnswer + schedules[selectedSchedule][2][1])) / 3
...
//        // [total,
//        ScheduleVariables.shared.updatedSessionsArray = [0,0,0,0,0,0,0] // Will be set to schedules[selectedSchedule][2][1]
...
//        if updating == false {
//            schedules[selectedSchedule][2][1] = ScheduleVariables.shared.updatedSessionsArray
