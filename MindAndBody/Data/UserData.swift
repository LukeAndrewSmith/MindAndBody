...
enum Register {
    ...
    // Weighted Movements
    // Metric
    static let weightsRegisterMetric1: [String: Int] =
        [
            // Gym ------------------------------------
            // Legs (Quads) ---------
            "squat": 10,
            "frontSquat": 10,
            "legPress": 10,
            "dumbellFrontSquat": 10,
            "legExtensions": 10,
            // Legs (Hamstrings/Glutes)
            "deadlift": 10,
            "romanianDeadlift": 10,
            "weightedHipThrust": 10,
            "legCurl": 10,
            "oneLeggedDeadlift": 10,
            // Legs (General)
            "lungeDumbell": 10,
            "bulgarianSplitSquat": 10,
            "weightedStepUp": 10,
            // Legs (Calves)
            "standingCalfRaise": 10,
            "seatedCalfRaise": 10,
            // Pull (Back) ---------
            "pullDown": 10,
            "kneelingPullDown": 10,
            "bentOverRowDumbell": 10,
            "tBarRow": 10,
            "rowMachine": 10,
            "latPullover": 10,
            // Pull (Upper Back)
            "facePull": 10,
            "leaningBackPullDown": 10,
            // Pull (Rear Delts)
            "bentOverBarbellRow": 10,
            // Pull (Traps)
            "shrugDumbell": 10,
            // Pull (Biceps)
            "hammerCurl": 10,
            ...
            // Pull (Forearms)
            "farmersCarry": 10,
            "reverseBarbellCurl": 10,
            // Push (Chest) ---------
            "benchPress": 10,
            "benchPressDumbell": 10,
            "semiInclineDumbellPress": 10,
            "platePress": 10,
            "barbellKneelingPress": 10,
            "dips": 10,
            // Push (Shoulders)
            "standingShoulderPressBarbell": 10,
            "standingShoulderPressDumbell": 10,
            "lateralRaise": 10,
            "frontRaise": 10,
            // Push (Triceps) // 46: !!!
            "closeGripBench": 10,
