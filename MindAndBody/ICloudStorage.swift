...
class ICloudFunctions {
    ...
    static let keyArray = ["userSettings", "selectedSchedule", "schedules", "difficultyLevels", "profileAnswers", "trackingDictionaries", "trackingProgress", "customSessions", "meditationTimer", "walkthroughs", "userHasValidSubscription"]
