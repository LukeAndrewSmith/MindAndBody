...
class StretchingScreenGeneral: UIViewController, UIScrollViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    @IBAction func expandImage(_ sender: Any) {
        ...
        // Demonstration Image
        demonstrationImageExpanded.frame = CGRect(x: 0, y: 36.75, width: imageViewExpanded.frame.size.width, height: imageViewExpanded.frame.size.height - 36.75 - 12.5)
...
//---------------------------------------------------------------------------------------------------------------
    ...
    func walkthroughMindBody() {
        ...
        case 0:
            ...
            label.text = NSLocalizedString("movementScreen1y", comment: "")
        ...
        case 1:
            ...
            label.text = NSLocalizedString("movementScreen2y", comment: "")
            walkthroughView.addSubview(label)
        ...
        case 3:
            // Clear Section
            let path = CGMutablePath()
            path.addRect(CGRect(x: 0, y: navigationBarHeight + UIApplication.shared.statusBarFrame.height + (setTop.constant / 2) - 3, width: setsRepsLabel.frame.size.width + 6, height: setTop.constant/2))
            path.addRect(screenSize)
            //
            let maskLayer = CAShapeLayer()
            maskLayer.backgroundColor = UIColor.black.cgColor
