//
//  WarmupScreenOverviewDetail.swift
//  MyFitnessMentor
//
...
class WarmupScreenOverviewDetailOld: UIViewController, UIScrollViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource, UINavigationControllerDelegate {
    ...
    func displayContent() {
        ...
        // Navigation Bar
        self.navigationTitle.text = NSLocalizedString(warmupArray[selectedMovement], comment: "")
