//
//  StretchingScreenLower.swift
//  MyFitnessMentor
//
//  Created by Luke Smith on 28.01.17.
...
class StretchingScreenCardio: UIViewController, UIScrollViewDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
...
//---------------------------------------------------------------------------------------------------------------
    ...
    func walkthroughMindBody() {
        ...
        case 0:
            ...
            label.text = NSLocalizedString("movementScreen1m", comment: "")
        ...
        case 1:
            ...
            label.text = NSLocalizedString("movementScreen2m", comment: "")
            walkthroughView.addSubview(label)
